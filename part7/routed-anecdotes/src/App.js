...
import { BrowserRouter as Router, Switch, Route, Link, useParams, Redirect, useRouteMatch } from 'react-router-dom'
...
const Anecdote = ({ anecdotes }) => {
  ...
  return (
    <div>
        ...
        <br></br>
        <div>
          for more content visit <a href={anecdote.info}>{anecdote.info}</a>
        </div>
        <br></br>
    </div>
  )
